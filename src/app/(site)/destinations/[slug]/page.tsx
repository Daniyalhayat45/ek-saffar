...
import { getDestinationBySlug, getPackagesByDestinationSlug } from "@/db/queries";
...
export default async function DestinationDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const relatedPackages = await getPackagesByDestinationSlug(slug);
      ...
      <section className="bg-basecamp py-16">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          <div className="mt-14 flex flex-wrap items-center justify-between gap-4">
            ...
            <Button asChild>
              <Link href="/booking">Enquire About This Trip</Link>
            </Button>
          </div>

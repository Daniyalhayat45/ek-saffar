...
function PackagesContent({ packages }: { packages: TourPackage[] }) {
    ...
    <>
      ...
      <section className="bg-basecamp py-16">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          ...
          {packages.length === 0 ? (
            <div className="mt-16 text-center text-fog">No packages have been added yet — check back soon.</div>
          ) : (
            <div
              className={cn(
                "mt-6 grid gap-6",
...
export function PackagesFilterClient({ packages }: { packages: TourPackage[] }) {
  return (
    <Suspense>
